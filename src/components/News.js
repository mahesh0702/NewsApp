...
async updateNews(){
  ...
  async componentDidMount() {
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=aeefb64c135b41c6b49cb8aa4dc0059c&page=1&pageSize=${this.props.pageSize}`;
    // this.setState({ loading: true });
    // let data = await fetch(url);
    // let pasredata = await data.json();
    // console.log(pasredata);
  ...
  handlePrevClick = async () => {
    ...
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=aeefb64c135b41c6b49cb8aa4dc0059c&page=${
    //   this.state.page - 1
          ...
          {!this.state.loading && this.state.articles.map((element) => {
            return (
              <div className="col-md-4" key={element.url}>
                <NewsItem
                  title={element.title ? element.title.slice(0, 26) : ""}
                  description={
